...
export class Render {
	...
	constructor(public canvas: HTMLCanvasElement) {
		...
		) as WebGLRenderingContext || die('Error creating WebGL context');
		this.gl = gl;
	...
	private initShader() {
		...
		[this.uCenterHi, this.uScale, this.uSize, this.uZoomCalc, this.uOrbitCalc, this.uDataCalc, this.uIterCalc, this.uReferenceOffset, this.uExact] = this.getUniformLocations(
			this.calcShader, [
